...
//@Transactional
//public interface TypeGlassDAO extends CrudRepository<TypeGlass, Long> {
//	static final Logger log = Logger.getLogger(TypeGlassDAO.class);
//
...
//	public TypeGlass findByIdtpglass(long idtpglass);
//
//	public List<TypeGlass> findAll();
//
//	
//}