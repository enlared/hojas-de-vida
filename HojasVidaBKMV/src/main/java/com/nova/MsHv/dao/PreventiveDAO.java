...
//@Transactional
//public interface PreventiveDAO extends CrudRepository<Preventive, Long> {
//	static final Logger log = Logger.getLogger(PreventiveDAO.class);
//
...
//	public Preventive findByIdprv(long idprv);
//
//	public List<Preventive> findAll();
//
//	
//}
