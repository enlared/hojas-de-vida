...
@Transactional
public interface InfluenceShoppingDAO extends CrudRepository<InfluenceShopping, Long> {
	static final Logger log = Logger.getLogger(InfluenceShoppingDAO.class);
	...
	public InfluenceShopping findByIdinfshp(long idinfshp);

	public List<InfluenceShopping> findAll();
