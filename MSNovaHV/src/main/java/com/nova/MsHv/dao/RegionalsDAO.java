...
@Transactional
public interface RegionalsDAO extends CrudRepository<Regionals, Long> {
	static final Logger log = Logger.getLogger(RegionalsDAO.class);
	...
	public Regionals findByIdrgn(long idrgn);

	public List<Regionals> findAll();
