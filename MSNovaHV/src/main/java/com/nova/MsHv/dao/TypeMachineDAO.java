...
@Transactional
public interface TypeMachineDAO extends CrudRepository<TypeMachine, Long> {
	static final Logger log = Logger.getLogger(TypeMachineDAO.class);
	...
	public TypeMachine findByIdtpmac(long idtpmac);
