...
//@Transactional
//public interface PermissionsxProfilesDAO extends CrudRepository<PermissionsxProfiles, Long> {
//	static final Logger log = Logger.getLogger(PermissionsxProfilesDAO.class);
//
...
//	public PermissionsxProfiles findByIdgnrprmxprf(long idgnrprmxprf);
//
//	public List<PermissionsxProfiles> findAll();
//
//	
//}
