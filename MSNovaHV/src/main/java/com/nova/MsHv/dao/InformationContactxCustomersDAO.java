...
@Transactional
public interface InformationContactxCustomersDAO extends CrudRepository<InformationContactxCustomers, Long> {
	static final Logger log = Logger.getLogger(InformationContactxCustomersDAO.class);
	...
	public InformationContactxCustomers findByIdgnrinfcontc(long idgnrinfcontc);

	public List<InformationContactxCustomers> findAll();
