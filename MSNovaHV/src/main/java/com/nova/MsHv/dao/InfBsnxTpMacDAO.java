...
@Transactional
public interface InfBsnxTpMacDAO extends CrudRepository<InfBsnxTpMac, Long> {
	static final Logger log = Logger.getLogger(InfBsnxTpMacDAO.class);
	...
	public InfBsnxTpMac findByIdinfbsnxtpmac(long idinfbsnxtpmac);

	public List<InfBsnxTpMac> findAll();
