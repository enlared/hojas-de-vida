...
//@Transactional
//public interface ListPricesDAO extends CrudRepository<ListPrices, Long> {
//	static final Logger log = Logger.getLogger(ListPricesDAO.class);
//
...
//	public ListPrices findByIdlstprc(long idlstprc);
//
//	public List<ListPrices> findAll();
//
//}
