...
@Transactional
public interface TermPurseSubDAO extends CrudRepository<TermPurseSub, Long> {
	static final Logger log = Logger.getLogger(TermPurseSubDAO.class);
	...
	public TermPurseSub findByIdtrmprs(long idtrmprs);

	public List<TermPurseSub> findAll();
