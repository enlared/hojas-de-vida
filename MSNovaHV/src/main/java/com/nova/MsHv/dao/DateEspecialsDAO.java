...
@Transactional
public interface DateEspecialsDAO extends CrudRepository<DateEspecials, Long> {
	static final Logger log = Logger.getLogger(DateEspecialsDAO.class);
	...
	public DateEspecials findByIddtspc(long iddtspc);

	public List<DateEspecials> findAll();
