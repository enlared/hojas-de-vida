...
@Transactional
public interface TermPurseRentDAO extends CrudRepository<TermPurseRent, Long> {
	static final Logger log = Logger.getLogger(TermPurseRentDAO.class);
	...
	public TermPurseRent findByIdtrmprsrnt(long idtrmprsrnt);

	public List<TermPurseRent> findAll();
