...
@Transactional
public interface GradeInfuenceDAO extends CrudRepository<GradeInfluence, Long> {
	static final Logger log = Logger.getLogger(GradeInfuenceDAO.class);
	...
	public GradeInfluence findByIdgrdinfl(long idgrdinfl);

	public List<GradeInfluence> findAll();
