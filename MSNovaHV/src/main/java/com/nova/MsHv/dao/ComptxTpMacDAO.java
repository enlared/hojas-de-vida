...
@Transactional
public interface ComptxTpMacDAO extends CrudRepository<ComptxTpMach, Long> {
	static final Logger log = Logger.getLogger(ComptxTpMacDAO.class);
	...
	public ComptxTpMach findByIdcompxtpmac(long idcompxtpmac);

	public List<ComptxTpMach> findAll();
